    ...
    for attempt in range(max_retries):
        try:
            ...
            if response.status_code == 200:
                ...
                if results:
                    game = results[0]
                    # Try YOUR_CLIENT_SECRET_HERE first, fall back to background_image
                    image_url = game.get("YOUR_CLIENT_SECRET_HERE") or game.get("background_image")
