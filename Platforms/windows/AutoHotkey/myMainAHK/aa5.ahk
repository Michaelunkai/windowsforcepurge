...
textShortcuts := Map(
    ...
    "wall", 'F:\\backup\\windowsapps\\installed\\myapps\\compiled_python\\wallpaper\\dist\\WallPaper.exe',
    "tttt", "SPLIT_TOP_APPS",
    "cahk", "closeahk",
    "tototo", "TODOIST_APP",
    "swemod", "swemod",
    ...
    , "parsec", 'Start-Process "F:\backup\windowsapps\installed\parsec\parsecd.exe" -WorkingDirectory "F:\backup\windowsapps\installed\parsec"'  ; <-- Parsec shortcut updated
    , "sssand", "F:\backup\windowsapps\installed\Sandboxie-Plus\SandMan.exe"  ; <-- NEW: Sandboxie-Plus SandMan shortcut
    , "sssync", "F:\backup\windowsapps\installed\Sandbox\ResilioSync\user\current\AppData\Roaming\Resilio Sync\Resilio Sync.exe"  ; <-- NEW: Resilio Sync shortcut
    , "myasus", "masus"
)
...
ShowHelpShortcuts() {
    try {
        ...
        leftColumnText .= "ppprof→brc | swemod→swemod | nnn→nnn`n"
