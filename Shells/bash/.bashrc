...
alias clean3="bash /mnt/f/study/shells/bash/scripts/CleanWSL2/CleanWSL2ubu5.sh && sudo mkdir -p /var/cache/apt-show-versions /var/log && sudo apt autoremove -y && sudo apt autoclean && disk && alert"
